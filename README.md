...
一个基于 AI 的智能学习辅导平台，帮助学生更好地理解和完成作业。

## ✨ 功能特点

- 🤖 **AI 智能辅导**：使用 DeepSeek AI 提供苏格拉底式教学指导
- 📚 **AI 知识点辅导**：基于教育理论的个性化知识点讲解，支持数学公式渲染
...
全新的AI知识点辅导功能，提供基于教育理论的个性化学习体验：

#### 核心特性

- **个性化教学**：根据学生年级和掌握度动态调整教学策略
- **教育理论支撑**：
  - 皮亚杰认知发展理论 - 适应不同年龄段的认知特点
  - 维果茨基最近发展区(ZPD) - 提供恰当难度的挑战
  - 布鲁纳发现学习 - 引导学生自主探索
  - 苏格拉底式提问 - 启发式教学方法
