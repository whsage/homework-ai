...
const HomeworkDetailPage = () => {
    ...
    return (
        <div className="h-[calc(100vh-6rem)] -m-6 md:p-6 flex flex-col md:flex-row gap-0 md:gap-6 bg-slate-50 box-border">
            {/* 移动端折叠按钮 - 固定在顶部 */}
            <div className="md:hidden bg-white border-b border-slate-200 flex-shrink-0">
                <button
            ...
            <div className="
                ...
                min-h-0 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col
            ">
