    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="AI奇妙知识点导航：涵盖小学、初中、高中数学、语文、英语全学科200+知识点。我们最大特点是不直接给答案，采用引导式学习！每个知识点都配有启发式AI辅导和练习题。" />
                ...
                <section className="max-w-5xl mx-auto px-6 py-8">
                    ...
                    <section className="mt-8 bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
                        ...
                        <div className="text-slate-600 dark:text-slate-400 text-sm space-y-3 leading-relaxed">
                            ...
                            <p>
                                所有知识点均深度贯彻“不直接给答案，引导式学习”的理念。通过苏格拉底式启发教学循循善诱，引导学生一步步独立思考，提供24小时不间断的在线辅导答疑服务。
                            </p>
                        </div>
                    </section>
                </section>
