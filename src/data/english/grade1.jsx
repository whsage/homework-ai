...
import WordMatchGame from '../../components/subjects/english/elementary/WordMatchGame';
import PhonicsSpinner from '../../components/subjects/english/elementary/PhonicsSpinner';
...
export const grade1Content = {
    'en1-l1-alphabet': {
        ...
        tabs: {
            ...
            interactive: (<WordMatchGame wordSet="greetings" />),
    ...
    'en1-l1-colors-numbers': {
        ...
        tabs: {
            ...
            interactive: (<WordMatchGame wordSet="colors" />),
    ...
    'en1-l2-songs': {
        ...
        tabs: {
            ...
            interactive: (<WordMatchGame wordSet="animals" />),
    ...
    'en1-l2-classroom': {
        ...
        tabs: {
            ...
            interactive: (<WordMatchGame wordSet="classroom" />),
