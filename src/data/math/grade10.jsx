...
export const grade10Content = {
    ...
    'high-10-1-sets': {
        meta: {
            title: "集合与常用逻辑用语 - 高一数学 | AI7Miao数学",
    ...
    'high-10-2-trig-graphs': {
        meta: {
            title: "三角函数图像与性质 - 高一数学 | AI7Miao数学",
