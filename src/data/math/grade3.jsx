...
export const grade3Content = {
    ...
    // ==================== L1-1. 多位数乘除法 ====================
    'g3-l1-multi-digit': {
        meta: { title: "多位数乘除法 - 三年级数学 | AI奇妙数学", description: "掌握两位数乘两位数、三位数除以一位数的笔算方法，加深乘除法的理解。", keywords: "多位数乘法,笔算乘法,三年级数学" },
        info: {
            title: "多位数乘除法",
    ...
    'g3-l1-fraction-intro': {
        meta: { title: "分数的初步认识 - 三年级数学 | AI奇妙数学", description: "认识分数，理解分子分母的含义，学会比较同分母分数大小和简单的分数加减法。", keywords: "分数,分子,分母,几分之几,三年级数学" },
        info: {
            title: "分数的初步认识",
    ...
    // ==================== L1-3. 周长计算 ====================
    'g3-l1-perimeter': {
        meta: { title: "周长计算（长正方形）- 三年级数学 | AI奇妙数学", description: "理解周长概念，掌握长方形和正方形周长公式，解决实际量周长问题。", keywords: "周长,长方形周长,正方形周长,三年级数学" },
        info: {
            title: "周长计算（长正方形）",
    ...
    // ==================== L1-4. 质量单位 ====================
    'g3-l1-mass-unit': {
        meta: { title: "质量单位 - 三年级数学 | AI奇妙数学", description: "认识克(g)和千克(kg)，理解质量单位的换算，学会在实际情境中选用合适单位。", keywords: "质量单位,克,千克,kg,g,三年级数学" },
        info: {
            title: "质量单位",
    ...
    // ==================== L2-1. 植树问题 ====================
    'g3-l2-tree-planting': {
        meta: { title: "植树问题 - 三年级思维进阶 | AI奇妙数学", description: "掌握直线植树、环形植树的棵数与间隔数的关系，解决实际植树问题。", keywords: "植树问题,间隔数,棵数,三年级思维进阶" },
        info: {
            title: "植树问题",
    ...
    'g3-l2-chicken-rabbit': {
        meta: { title: "鸡兔同笼（初阶）- 三年级思维进阶 | AI奇妙数学", description: "学习假设法解决鸡兔同笼问题，培养逻辑推理和方程思维。", keywords: "鸡兔同笼,假设法,三年级思维进阶" },
        info: {
            title: "鸡兔同笼（初阶）",
    ...
    // ==================== L2-3. 盈亏问题 ====================
    'g3-l2-profit-loss': {
        meta: { title: "盈亏问题 - 三年级思维进阶 | AI奇妙数学", description: "学习用差+差或差-差的方法解决盈亏问题，找出人数和物品数量。", keywords: "盈亏问题,三年级思维进阶,假设法" },
        info: {
            title: "盈亏问题",
    ...
    // ==================== L2-4. 归一问题 ====================
    'g3-l2-unit-problem': {
        meta: { title: "归一问题 - 三年级思维进阶 | AI奇妙数学", description: "通过先求单位量（单价、单速等），解决正比例相关的实际问题。", keywords: "归一问题,单位量,三年级思维进阶" },
        info: {
            title: "归一问题",
    ...
    // ==================== L2-5. 年龄问题 ====================
    'g3-l2-age-problem': {
        meta: { title: "年龄问题 - 三年级思维进阶 | AI奇妙数学", description: "利用年龄差不变的性质，解决今年/N年前/N年后的年龄推算问题。", keywords: "年龄问题,年龄差,三年级思维进阶" },
        info: {
            title: "年龄问题",
