...
export const grade1Content = {
    ...
    'g1-l1-shapes': {
        meta: {
            title: "认识图形（长方形·正方形·圆）- 一年级数学 | AI奇妙数学",
    ...
    'g1-l2-fill-numbers': {
        meta: {
            title: "简单枚举（填数游戏）- 一年级思维进阶 | AI奇妙数学",
